...
resume_from_checkpoint_label.grid(row=1, column=0, sticky='w', pady=5)
resume_from_checkpoint_entry.grid(row=1, column=1, pady=5)
resume_from_checkpoint_button.grid(row=1, column=2, pady=5)
