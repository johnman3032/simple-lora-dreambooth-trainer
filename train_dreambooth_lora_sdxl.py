...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        choices=["AdamW", "Adafactor", "Prodigy", "CAME"],
    )
...
def main(args):
    ...
    #    except ImportError:
    #        raise ImportError(
    #            "Failed to import CAME optimizer."
    #        )
    ...
    if args.pre_compute_text_embeddings:
        ...
        #    with torch.no_grad():
        #        text_inputs = tokenize_prompt(tokenizers, prompt, tokenizer_max_length=args.tokenizer_max_length)
        ...
        if accelerator.is_main_process:
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                pipeline = StableDiffusionXLPipeline.from_pretrained(
                    args.pretrained_model_name_or_path,
                    vae=vae,
                    text_encoder=None if args.pre_compute_text_embeddings else accelerator.unwrap_model(text_encoder_one),
                    text_encoder_2=None if args.pre_compute_text_embeddings else accelerator.unwrap_model(text_encoder_two),
